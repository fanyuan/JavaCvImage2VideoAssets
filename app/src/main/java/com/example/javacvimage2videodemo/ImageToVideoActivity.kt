...
class ImageToVideoActivity : AppCompatActivity() {
    ...
    val paths:Array<String> = arrayOf("file:////android_asset/icon1.bmp","file:////android_asset/icon2.bmp",
                                      "file:////android_asset/icon3.bmp","file:////android_asset/icon4.bmp",
                                      "file:////android_asset/icon5.bmp","file:////android_asset/icon6.bmp",
                                      "file:////android_asset/icon7.bmp","file:////android_asset/icon8.bmp")
